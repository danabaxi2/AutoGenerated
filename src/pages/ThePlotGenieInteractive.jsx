...
export default function ThePlotGenieInteractive() {
  ...
  return (
    <Scene bg="#000">
      ...
      {/* ── Background image ───────────────────────────────────── */}
      <img
        src={`${base}images/genie_bg.png`}
        alt=""
        style={{ position: 'absolute', left: 420, top: 150, width: 600, height: 600, objectFit: 'cover', opacity: 0.6 }}
      />

      {/* ── Images (same as Plot Genie) ─────────────────────────── */}
      <img
      ...
      {/* ── Red button (active / spinning state) ───────────────── */}
      <div
        style={{
          position: 'absolute',
          left: 765,
